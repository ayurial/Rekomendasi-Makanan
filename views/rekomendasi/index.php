            ...
            <div class="col-12">
              ...
              <div class="invoice p-3 mb-3">
                ...
                if ($rekomendasi == NULL) { ?>
                          ...
                          <table class="table table-striped">
                            ...
                            <tbody class="list">
                              ...
                              foreach ($rekomendasi as $hasil) :
                                $karbohidrat = $karbohidrat + $hasil->jumlah_karbohidrat;
                                $lemak = $lemak + $hasil->jumlah_lemak;
                                $total = $total + $hasil->harga;
                                $protein = $protein + $hasil->jumlah_protein ?>
                                      ...
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h4 class="modal-title" id="modal_ubah<?php echo $hasil->id_makanan; ?>">Resep Makanan</h4>
                  ...
                  <h5>Kebutuhan karbohidrat terpenuhi <?php echo $karbohidrat ?> </h5>
                  <h5>Kebutuhan protein terpenuhi <?php echo $protein ?> </h5>
                  <h5>Kebutuhan lemak terpenuhi <?php echo $lemak ?> </h5>
                  <h5>Total Harga Makanan <?php echo $total ?> </h5>
